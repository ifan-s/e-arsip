...
<nav class="blue-grey darken-1">
    <div class="nav-wrapper">
        <a href="./" class="brand-logo center hide-on-large-only"><i class="material-icons md-36">school</i>FST</a>
        ...
        <ul class="center hide-on-med-and-down" id="nv">
            <li><a href="./" class="ams hide-on-med-and-down"><i class="material-icons md-36">school</i> FST</a></li>
            <li><div class="grs"></></li>
           ...
           <?php
                if($_SESSION['admin'] == 1 || $_SESSION['admin'] == 3){ ?>
            <li><a href="?page=pk" data-activates="transaksi">Pengajuan Kegiatan 
            <?php
                }
            ?>
           ...
           <?php
                if($_SESSION['admin'] == 1 || $_SESSION['admin'] == 3){ ?>
            <li><a href="?page=ph" data-activates="transaksi">Produk Hukum FST 
            <?php
                }
            ?>
