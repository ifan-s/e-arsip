...
<head>
    ...
    <title>E-ARSIP Fakultas Sains dan Teknologi</title>
    ...
    <?php
        ...
        if(!empty($logo)){
            ...
            echo '<link rel="icon" href="./asset/img/logo.jpg" type="image/x-icon">';
        }
    ?>
    <!-- Meta END -->
                ...
                <div class="card-panel z-depth-2" id="login">
                    ...
                    <div class="col s12">
                        <div class="card-content">
                            <h5 class="center" id="title">E-ARSIP</h5>
                            <?php
                                if(!empty($data['logo'])){
                                    echo '<img id="logo" src="./upload/'.$data['logo'].'"/>';
                                } else {
                                    echo '<img id="logo" src="./asset/img/logo.jpg"/>';
                                }
                            ?>
