                ...
                echo '
                    <table class="bordered" id="tbl">
                        <tbody>
                            ...
                            <tr>';
                            $query3 = mysqli_query($config, "SELECT * FROM tbl_disposisi JOIN tbl_pengajuan_kegiatan ON tbl_disposisi.id_surat = tbl_pengajuan_kegiatan.id_surat WHERE tbl_disposisi.id_surat='$id_surat'");
