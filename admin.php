        ...
        if(isset($_REQUEST['page'])){
            ...
            switch ($page) {
                ...
                case 'gsk':
                    ...
                    break;
                case 'pk':
                    include "pengajuan_kegiatan.php";
                    break;
                case 'ph':
            ...
            <div class="col s12">
                <div class="card">
                    <div class="card-content">
                        ...
                        <?php
                            if($_SESSION['admin'] == 1){
                                echo "<strong>Sekeretaris Jurusan</strong>. Anda memiliki akses penuh terhadap sistem.";
                            } elseif($_SESSION['admin'] == 2){
                                echo "<strong>Administrator</strong>. Berikut adalah statistik data yang tersimpan dalam sistem.";
                            } else {
                                echo "<strong>Kepala Jurusan</strong>. Berikut adalah statistik data yang tersimpan dalam sistem.";
                            }?></p>
                    </div>
                </div>
            </div>
