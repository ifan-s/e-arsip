...
MySQL - 10.1.31-MariaDB : Database - arsip
*********************************************************************
*/
...
(1,'Universitas Negeri Sunan Ampel Surabaya','Fakultas Sains dan Teknologi','Kepala Jurusan Teknik','Jl. A. Yani. Depan Polda CUY','Mujib Ridwan ','77889905','http://www.uinsby.ac.id','uinsa@uinsby.ac.id','logo.jpg',1);
...
/*Data for the table `tbl_klasifikasi` */
...
(50,'333','himaprosif','Himpunan Mahasiswa Sistem Informasi',1),
(51,'311','UINSA','Universitas Negeri Islam Sunan Ampel Surabaya',1),
(52,'355','Dema FST','Dewan Eksekutif Mahasiswa',1);

/*Table structure for table `tbl_pengajuan_kegiatan` */

DROP TABLE IF EXISTS `tbl_pengajuan_kegiatan`;

CREATE TABLE `tbl_pengajuan_kegiatan` (
  `id_surat` int(20) NOT NULL AUTO_INCREMENT,
  `no_agenda` int(20) DEFAULT NULL,
...
/*Data for the table `tbl_pengajuan_kegiatan` */

insert  into `tbl_pengajuan_kegiatan`(`id_surat`,`no_agenda`,`no_surat`,`asal_surat`,`isi`,`kode`,`indeks`,`tgl_surat`,`tgl_diterima`,`file`,`keterangan`,`id_user`) values 
(1,7,'333','Himpunan mahasiswa sistem informasi Fakultas Sains dan Teknologi','Surat Pengajuan Kegiatan Seminar Nasional','333','M.1','2019-12-20','2019-12-20','8282-SK-Penetapan-Hasil-Tes-Seleksi-Masuk-Mahasisw','Penting','1'),
(4,11,'2398401','dfhsakjfh','ehfhdsakfhl','....................','jdsfkahkj','2019-12-08','2019-12-20','9398-Surat Rekomendasi 0215.docx','hsadfjkhalkdsjhwe','4');

/*Table structure for table `tbl_produk_hukum` */

DROP TABLE IF EXISTS `tbl_produk_hukum`;
...
/*Data for the table `tbl_produk_hukum` */

insert  into `tbl_produk_hukum`(`id_surat`,`no_agenda`,`no_surat`,`asal_surat`,`isi`,`kode`,`indeks`,`tgl_surat`,`file`,`keterangan`,`id_user`,`tgl_diterima`) values 
(1,1,'311','Departemen Kemahasiswaan dan Organisasi','Tata tertib berbusana dan berperilaku dalam kampus','311','PH.1','2019-12-20','','wajib','1','2019-12-20');
...
CREATE TABLE `tbl_sett` (
  ...
  `id_user` tinyint(2) NOT NULL,
  `pengajuan_kegiatan` tinyint(2) DEFAULT NULL,
  `produk_hukum` tinyint(2) DEFAULT NULL,
  PRIMARY KEY (`id_sett`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `tbl_sett` */

insert  into `tbl_sett`(`id_sett`,`surat_masuk`,`surat_keluar`,`referensi`,`id_user`,`pengajuan_kegiatan`,`produk_hukum`) values 
(1,10,5,10,1,100,100);
...
(5,7,'Dosen','042/067 / SMk-AH/I/2016','Surat undangan rapat dinas koordinasi ujian sekolah\r\n','420','2016-02-01','2016-07-24','3854-SK. Penetapan Mahasiswa Baru.pdf','Wajib Hadir',1),
(6,900,'dekan','bgm 112','jaskldjaskllkfasjklj','9998','2019-12-18','2019-12-20','6312-PERMOHONAN SURAT  REKOMENDASI DEKAN.doc','wkwkkwkw',4);
...
(14,6,'560/402.1/411.203/2020','Dinas Sosial Tenaga Kerja Dan Transmigrasi Daerah Kabupaten Mojokerto','Surat undangan untuk menghadiri acara Pameran Bursa Kerja Untuk Percepatan Penempatan Tenaga Kerja / Job Fair Tahun 2020','421','A.2','2016-05-12','2016-07-24','4460-SK-Penetapan-Hasil-Tes-Seleksi-Masuk-Mahasiswa-Baru-SPs-UPI-2018-Gelombang-I.pdf','Segera laksanakan',1),
(19,119,'980801sada','Masjid Ulul Albab','Bacoooooooooooooooooooottttttttttttttttttttttttttttttt','0002','9990A','2019-12-16','2019-12-20','7548-Surat Rekomendasi 0215 (1).docx','muehehehehehhehe',4);
...
(1,'Kahim','dbcddd2b55ec5b104a2a1a64b8707d4a','Ifan Setyowinarno','-76217059',1),
(5,'Azizi','39e8cd2ed667db8a1f24aabba6765140','cok','7621706',3);
