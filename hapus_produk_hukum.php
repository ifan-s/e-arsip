    	...
    	if(mysqli_num_rows($query) > 0){
				...
				<div class="row jarak-card">
                    ...
                    <div class="card">
                        ...
                        <div class="card-action">
        	                <a href="?page=ph&act=del&submit=yes&id_surat='.$row['id_surat'].'" class="btn-large deep-orange waves-effect waves-light white-text">HAPUS <i class="material-icons">delete</i></a>
        	                <a href="?page=ph" class="btn-large blue waves-effect waves-light white-text">BATAL <i class="material-icons">clear</i></a>
    	                </div>
    	            </div>
                </div>
            </div>
            <!-- Row form END -->';
            	...
            	if(isset($_REQUEST['submit'])){
                    ...
                    if(!empty($row['file'])){
                        unlink("upload/produk_hukum/".$row['file']);
                        $query = mysqli_query($config, "DELETE FROM tbl_produk_hukum WHERE id_surat='$id_surat'");
                		...
                		if($query == true){
                            ...
                            echo '<script language="javascript">
                                    window.location.href="./admin.php?page=ph&act=del&id_surat='.$id_surat.'";
                                  </script>';
                		}
                	} else {
