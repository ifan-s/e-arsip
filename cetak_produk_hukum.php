                ...
                echo '
                    <table class="bordered" id="tbl">
                        <tbody>
                            ...
                            <tr>';
                            $query3 = mysqli_query($config, "SELECT * FROM tbl_disposisi JOIN tbl_produk_hukum ON tbl_disposisi.id_surat = tbl_produk_hukum.id_surat WHERE tbl_disposisi.id_surat='$id_surat'");
